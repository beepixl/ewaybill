    ...
    <x-jet-form-section :submit="$action" class="mb-4">
        ...
        <x-slot name="form">
            @foreach ($columns as $col)
                @if (!in_array($col, ['id', 'created_at', 'updated_at', 'customer_type', 'country', 'currency']))
                ...
                @elseif($col == 'customer_type')
                    <div class="form-group">
                        ...
                        <select wire:model.defer="customer.customer_type"
                            class="mt-1 block w-full form-control shadow-none" id="">
                            <option value="local"
                                @isset($customer) {{ $customer->customer_type == 'local' ? 'selected' : '' }} @endisset>
                                Local</option>
                            <option value="global"
                                @isset($customer) {{ $customer->customer_type == 'global' ? 'selected' : '' }} @endisset>
                                Global</option>
                        </select>
                ...
                @elseif($col == 'country')
                    <div class="form-group">
                        ...
                        <select wire:model.defer="customer.country" class="mt-1 block w-full form-control shadow-none">
                        ...
                        <x-jet-input-error for="customer.country" class="mt-2" />
                    </div>
                @elseif($col == 'currency')
                    <div class="form-group">
                        <x-jet-label for="Currency" value="currency" />
