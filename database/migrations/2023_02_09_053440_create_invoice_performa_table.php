...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('invoice_performa', function (Blueprint $table) {
            ...
            $table->string('fromPincode',50)->default(0);
            $table->string('actFromStateCode',50)->default(0);
            $table->string('fromStateCode',50)->default(0);
            ...
            $table->string('toPincode',50)->nullable();
            $table->string('actToStateCode',50)->nullable();
            $table->string('toStateCode',50)->nullable();
