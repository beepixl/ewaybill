                    ...
                    <div class="col-auto md:grid grid-cols-2 gap-2">
                        ...
                        <div class="form-group">
                            ...
                            <select name="transMode" class="mt-1 block w-full form-control shadow-none">
                                ...
                                <option value="1"  @isset($invoice) {{ $invoice->transMode == 1 ? 'selected' : '' }}  @endisset>Road</option>
                                <option value="2" @isset($invoice) {{ $invoice->transMode == 2 ? 'selected' : '' }}  @endisset >Rail</option>
                                <option value="3" @isset($invoice) {{ $invoice->transMode == 3 ? 'selected' : '' }}  @endisset >Air</option>
                                <option value="4" @isset($invoice) {{ $invoice->transMode == 4 ? 'selected' : '' }}  @endisset >Ship</option>
                                <option value="5" @isset($invoice) {{ $invoice->transMode == 5 ? 'selected' : '' }}  @endisset >inTransit</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="transactionType" class="mt-1 block w-full form-control shadow-none">
                                ...
                                <option value="1" @isset($invoice) {{ $invoice->transactionType == 1 ? 'selected' : '' }}  @endisset>Regular</option>
                                <option value="2" @isset($invoice) {{ $invoice->transactionType == 2 ? 'selected' : '' }}  @endisset>Bill To - Ship To</option>
                                <option value="3" @isset($invoice) {{ $invoice->transactionType == 3 ? 'selected' : '' }}  @endisset>Bill From - Dispatch From</option>
                                <option value="4" @isset($invoice) {{ $invoice->transactionType == 4 ? 'selected' : '' }}  @endisset>Combination of 2 and 3</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="vehicleType" class="mt-1 block w-full form-control shadow-none">
                                ...
                                <option value="R"  @isset($invoice) {{ $invoice->vehicleType == 'R' ? 'selected' : '' }}  @endisset>Regular</option>
                                <option value="O"  @isset($invoice) {{ $invoice->vehicleType == 'O' ? 'selected' : '' }}  @endisset>ODC(Over Dimentional Cargo)</option>
                            </select>
                        </div>
